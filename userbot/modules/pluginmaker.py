			...
			if sleep_t == "":
				...
				if sec == "":
					...
					if sec.lower() == "edit":
						...
						await q.client.send_file(q.chat_id, f"./epicuserbot{dosya_name}.py", force_document=True, caption="Bu Plugin @EpicUserBot Tarafından Yapılmıştır..")
						await q.delete()
						os.remove(f"./epicuserbot{dosya_name}.py")
						return
